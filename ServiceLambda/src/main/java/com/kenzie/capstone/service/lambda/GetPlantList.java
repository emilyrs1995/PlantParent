...
public class GetPlantList implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        PlantListLambdaService plantListLambdaService = serviceComponent.providePlantListLambdaService();
        ...
        try {
            List<GetPlantListResponse> responseList = plantListLambdaService.getPlantList(plantName);
